...
Manifest of **196 records** over 16 subsystems.

| status | records | meaning |
| --- | ---: | --- |
| EXACT_SOURCE | 85 | Read from primary source and reproduced. The record names the address, asset or schema it was read from. |
