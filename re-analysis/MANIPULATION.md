...
| path segment wire layouts and `ExecutePath {pathID, manualSpeed}`, `ClearPath {pathID}` | `PathSender` | NATIVE packing (`PathDolerOuter::Dole` 0x00507F40..0x00508056, `PathComponent::ExecutePath` 0x0064A426); names from PyCozmo |
