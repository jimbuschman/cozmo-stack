...
| --- | --- | --- |
| **Wwise bank and media decoding** | Taken up as M6 and partly closed: event resolution and the 220 mono ADPCM files are done, the 1987 Wwise Vorbis files are not. See `WWISE_AUDIO.md`. | A packed codebook library committed to this repository, a port of ww2ogg's bitstream rebuilder, and a Vorbis decoder. |
