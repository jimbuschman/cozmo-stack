...
public enum RobotMessageId : byte
{
    ...
    /// <summary>HeadAngle (engine_to_robot); size 3; statically_verified</summary>
    AnimHeadAngle = 0x93,
    /// <summary>LiftHeight (engine_to_robot); size 3; statically_verified</summary>
    AnimLiftHeight = 0x94,
...
public static class MessageCatalog
{
    public static readonly IReadOnlyDictionary<RobotMessageId, MessageInfo> ById = new Dictionary<RobotMessageId, MessageInfo>
    {
        ...
        [RobotMessageId.AbsLocalizationUpdate] = new(RobotMessageId.AbsLocalizationUpdate, "absLocalizationUpdate", "AbsoluteLocalizationUpdate", MessageDirection.EngineToRobot, 24, false, Subsystem.LocalizationNavigation, ProbeSafety.StateChange, LayoutConfidence.HardwareRefined, VerificationStatus.HardwareVerified, "SetOrigin"),
        ...
        [RobotMessageId.FallingStopped] = new(RobotMessageId.FallingStopped, "fallingStopped", "FallingStopped", MessageDirection.RobotToEngine, 12, false, Subsystem.RobotStateSensors, ProbeSafety.StateChange, LayoutConfidence.HardwareRefined, VerificationStatus.StaticallyVerified, "FallingStopped"),
