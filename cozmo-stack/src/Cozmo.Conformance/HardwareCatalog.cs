...
public static class HardwareCatalog
{
    ...
    private static IReadOnlyList<HardwareCheck> Build() => new[]
    {
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M2-001", "M3-002" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M5-001", "M5-004" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M9-016" }, CoreRegressions = new[] { "CORE-006" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M4-001", "M4-002" },
            Requires = new[] { "LINK", "D" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M5-004" }, CoreRegressions = new[] { "CORE-001" },
            Requires = new[] { "MOV" },
            Timeout = TimeSpan.FromMinutes(2),
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M5-001" }, CoreRegressions = new[] { "CORE-003" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M5-001" }, CoreRegressions = new[] { "CORE-002" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M11-001", "M11-005", "M11-012" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M13-006", "M12-005" }, CoreRegressions = new[] { "CORE-005" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M10-001", "M10-002" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M11-009", "M13-003" }, CoreRegressions = new[] { "CORE-008" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M13-001", "M13-002" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M12-003", "M12-005" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M15-001", "M15-004" }, CoreRegressions = new[] { "CORE-009" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M14-002", "M15-001" }, CoreRegressions = new[] { "CORE-009" },
