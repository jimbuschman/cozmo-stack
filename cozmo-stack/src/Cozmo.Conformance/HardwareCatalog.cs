...
public static class HardwareCatalog
{
    ...
    private static IReadOnlyList<HardwareCheck> Build() => new[]
    {
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M5-008", "M5-006" }, CoreRegressions = new[] { "CORE-003" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M1-014" }, CoreRegressions = new[] { "CORE-002" },
        ...
        new HardwareCheck
        {
            ...
            FidelityRecords = new[] { "M4-009", "M4-010", "M4-011" },
